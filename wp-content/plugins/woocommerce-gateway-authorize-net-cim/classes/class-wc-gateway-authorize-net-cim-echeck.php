	...
	public function get_icon() {
		...
		if ( $this->icon ) {
			...
			if ( is_readable( $wc_authorize_net_cim->get_plugin_path() . '/assets/images/card-echeck.png' ) ) {
				$icon .= '<img src="' . esc_url( SV_WC_Plugin_Compatibility::force_https_url( $wc_authorize_net_cim->get_plugin_url() ) . '/assets/images/card-echeck.png' ) . '" alt="' . esc_attr( strtolower( 'echeck' ) ) . '" />';
			}
		}
